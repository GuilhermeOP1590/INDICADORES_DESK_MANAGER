  ...
  return (
    <div className="app">
      <header className="app-header">
        <div>
          <h1>Indicadores de Chamados de Suporte</h1>
          {state.payload && (
            <div className="meta">
      ...
      {state.payload && state.payload.registrosCarregados < state.payload.totalNoDesk && (
        <div className="state-banner warning">
          Exibindo os {state.payload.registrosCarregados} chamados mais recentes de um total de {state.payload.totalNoDesk} — a API do
          DeskManager limita o retorno por chamada e ainda estamos confirmando os parâmetros de paginação.
        </div>
      )}
        ...
        <>
          ...
          <section className="panel-grid">
            ...
            <div className="panel full-width">
              ...
              <p className="subtitle">Top 10 operadores por volume total</p>
